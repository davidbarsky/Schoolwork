...
public class CS11Editor {
	...
	public static void interact(Scanner console) {
		//The sole CS11AImage instance this program uses.
		CS11AImage im1 = null;
	...
	//Tries to load an image file into a CS11AImage instance.
	//Returns null if load fails.
	public static CS11AImage loadImage(Scanner console) {
		//load file
